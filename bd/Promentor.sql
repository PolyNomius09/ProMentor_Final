...
CREATE TABLE Calificaciones (
  ...
  -- Modificar la restricci�n FK_Usuario_Calificaciones en Calificaciones para ON DELETE CASCADE
...
('Redes de Computadoras', 'Protocolos de Comunicaci�n', 'Estudio de los protocolos b�sicos de comunicaci�n en redes.', 20, 'A101'),
('Programaci�n Avanzada', 'Python para Redes', 'Uso de Python para la gesti�n y automatizaci�n de redes.', 25, 'B202'),
('Seguridad Inform�tica', 'Criptograf�a', 'Introducci�n a la criptograf�a y su aplicaci�n en la seguridad de la informaci�n.', 15, 'C303'),
('Sistemas Operativos', 'Linux', 'Administraci�n y uso de sistemas operativos basados en Linux.', 18, 'D404'),
('Bases de Datos', 'SQL', 'Fundamentos y uso del lenguaje SQL para la gesti�n de bases de datos.', 22, 'E505'),
('Desarrollo Web', 'HTML y CSS', 'Introducci�n al desarrollo de p�ginas web con HTML y CSS.', 30, 'F606'),
('Redes Inal�mbricas', 'Wi-Fi', 'Conceptos y configuraci�n de redes inal�mbricas Wi-Fi.', 28, 'G707'),
('Programaci�n', 'JavaScript', 'Fundamentos de la programaci�n en JavaScript.', 24, 'H808'),
('Administraci�n de Servidores', 'Windows Server', 'Configuraci�n y administraci�n de servidores Windows.', 20, 'I909'),
('Telecomunicaciones', 'Tecnolog�as 5G', 'Estudio de las tecnolog�as y aplicaciones de las redes 5G.', 26, 'J101'),
('Seguridad en Redes', 'Firewalls', 'Implementaci�n y configuraci�n de firewalls en redes.', 25, 'K202'),
('IoT', 'Internet de las Cosas', 'Introducci�n al Internet de las Cosas y sus aplicaciones.', 20, 'L303'),
('Programaci�n de Sistemas', 'C y C++', 'Desarrollo de software de sistemas utilizando C y C++.', 18, 'M404'),
('Administraci�n de Redes', 'Cisco', 'Configuraci�n de redes utilizando tecnolog�as y dispositivos Cisco.', 30, 'N505'),
('Ingenier�a de Software', 'Metodolog�as �giles', 'Uso de metodolog�as �giles en el desarrollo de software.', 15, 'O606'),
('Seguridad en la Nube', 'AWS', 'Implementaci�n de seguridad en servicios de Amazon Web Services.', 25, 'P707'),
('Big Data', 'Hadoop', 'Introducci�n a las tecnolog�as Big Data y uso de Hadoop.', 28, 'Q808'),
('Inteligencia Artificial', 'Machine Learning', 'Fundamentos y aplicaciones del Machine Learning.', 22, 'R909'),
('Programaci�n M�vil', 'Android', 'Desarrollo de aplicaciones m�viles para Android.', 30, 'S101'),
('Virtualizaci�n', 'VMware', 'Implementaci�n y gesti�n de entornos virtualizados con VMware.', 15, 'T202'),
('Redes de Computadoras II', 'IPv6', 'Transici�n y configuraci�n de redes utilizando IPv6.', 18, 'U303'),
('Seguridad Inform�tica Avanzada', 'Penetration Testing', 'T�cnicas y herramientas para realizar pruebas de penetraci�n.', 20, 'V404'),
('Programaci�n para Redes', 'Sockets en Python', 'Desarrollo de aplicaciones de red utilizando sockets en Python.', 25, 'W505'),
('Computaci�n en la Nube', 'Azure', 'Uso de servicios de Microsoft Azure para soluciones en la nube.', 20, 'X606'),
('Seguridad de Aplicaciones Web', 'OWASP', 'Mejores pr�cticas y herramientas para la seguridad de aplicaciones web seg�n OWASP.', 18, 'Y707'),
('Blockchain', 'Tecnolog�as Blockchain', 'Introducci�n a las tecnolog�as blockchain y sus aplicaciones.', 30, 'Z808'),
('Redes Privadas Virtuales', 'VPN', 'Configuraci�n y uso de redes privadas virtuales (VPN).', 15, 'A909'),
('Ingenier�a de Software II', 'DevOps', 'Pr�cticas y herramientas DevOps para la integraci�n continua.', 25, 'B101'),
('Computaci�n Gr�fica', 'OpenGL', 'Desarrollo de aplicaciones gr�ficas utilizando OpenGL.', 28, 'C202'),
...
('Ingenier�a en Cibern�tica'),
('Ingenier�a en Rob�tica');
INSERT INTO Asesor (boleta_asesor, nombre_asesor, apellido_asesor, descripcion) VALUES
('A0001', 'Juan', 'P�rez', 'Especialista en redes de computadoras y seguridad inform�tica.'),
('A0002', 'Mar�a', 'Garc�a', 'Experta en programaci�n en Python y desarrollo web.'),
('A0003', 'Luis', 'Mart�nez', 'Consultor en telecomunicaciones y tecnolog�as 5G.'),
('A0004', 'Ana', 'Rodr�guez', 'Profesora de bases de datos y administraci�n de sistemas.'),
('A0005', 'Carlos', 'L�pez', 'Ingeniero de software con experiencia en metodolog�as �giles.'),
('A0006', 'Elena', 'Hern�ndez', 'Especialista en seguridad inform�tica y criptograf�a.'),
('A0007', 'Jorge', 'Gonz�lez', 'Experto en sistemas operativos y virtualizaci�n.'),
('A0008', 'Laura', 'S�nchez', 'Desarrolladora de aplicaciones m�viles y tecnolog�as IoT.'),
('A0009', 'Pedro', 'Ram�rez', 'Consultor en big data y an�lisis de datos.'),
('A0010', 'Luc�a', 'Cruz', 'Profesora de inteligencia artificial y machine learning.'),
('A0011', 'Miguel', 'Torres', 'Especialista en administraci�n de redes y dispositivos Cisco.'),
('A0012', 'Sof�a', 'Flores', 'Ingeniera en telecomunicaciones con enfoque en redes inal�mbricas.'),
('A0013', 'Fernando', 'Jim�nez', 'Experto en programaci�n avanzada y desarrollo de sistemas.'),
...
('A0016', 'Patricia', 'Guti�rrez', 'Profesora de computaci�n gr�fica y tecnolog�as de visualizaci�n.'),
('A0017', 'H�ctor', 'Ramos', 'Especialista en seguridad de aplicaciones web y OWASP.'),
('A0018', 'Sandra', 'Ruiz', 'Consultora en blockchain y tecnolog�as distribuidas.'),
('A0019', 'Alberto', 'Mu�oz', 'Ingeniero de redes con experiencia en IPv6 y VPN.'),
('A0020', 'Daniela', 'Paredes', 'Desarrolladora en sistemas distribuidos y microservicios.'),
('A0021', 'Ra�l', 'Castillo', 'Experto en administraci�n de servidores y sistemas operativos.'),
('A0022', 'M�nica', 'Vargas', 'Consultora en ingenier�a de software y metodolog�as �giles.'),
('A0023', 'Francisco', 'Delgado', 'Ingeniero en big data y an�lisis de datos.'),
('A0024', 'Gabriela', 'R�os', 'Especialista en inteligencia artificial y machine learning.'),
('A0025', 'Tom�s', 'Aguilar', 'Consultor en telecomunicaciones y redes 5G.'),
('A0026', 'Ver�nica', 'Mendoza', 'Desarrolladora en aplicaciones m�viles y tecnolog�as IoT.'),
('A0027', 'Gustavo', 'Medina', 'Especialista en sistemas operativos y virtualizaci�n.'),
('A0028', 'Beatriz', 'Soto', 'Profesora de bases de datos y administraci�n de sistemas.'),
('A0029', 'Eduardo', 'Pe�a', 'Ingeniero de software con experiencia en metodolog�as �giles.'),
('A0030', 'Claudia', 'Navarro', 'Experta en seguridad inform�tica y criptograf�a.');
...
VALUES
('U0001', 'password1', 'Juan', 'P�rez', 'juan.perez@example.com', 1, 1),
('U0002', 'password2', 'Mar�a', 'Garc�a', 'maria.garcia@example.com', 2, 2),
('U0003', 'password3', 'Carlos', 'Mart�nez', 'carlos.martinez@example.com', 3, 3),
('U0004', 'password4', 'Laura', 'Hern�ndez', 'laura.hernandez@example.com', 4, 4),
('U0005', 'password5', 'Pedro', 'L�pez', 'pedro.lopez@example.com', 5, 5),
('U0006', 'password6', 'Ana', 'Torres', 'ana.torres@example.com', 1, 2),
('U0007', 'password7', 'Javier', 'D�az', 'javier.diaz@example.com', 2, 3),
('U0008', 'password8', 'Sof�a', 'Jim�nez', 'sofia.jimenez@example.com', 3, 4),
('U0009', 'password9', 'Diego', 'Guti�rrez', 'diego.gutierrez@example.com', 4, 5),
('U0010', 'password10', 'M�nica', 'V�zquez', 'monica.vazquez@example.com', 5, 1),
('U0011', 'password11', 'Ra�l', 'Reyes', 'raul.reyes@example.com', 1, 3),
('U0012', 'password12', 'Luc�a', 'Mendoza', 'lucia.mendoza@example.com', 2, 4),
('U0013', 'password13', 'Pablo', 'Castro', 'pablo.castro@example.com', 3, 5),
('U0014', 'password14', 'Elena', 'Ortega', 'elena.ortega@example.com', 4, 1),
('U0015', 'password15', 'Gonzalo', 'S�nchez', 'gonzalo.sanchez@example.com', 5, 2),
('U0016', 'password16', 'Valeria', 'Delgado', 'valeria.delgado@example.com', 1, 4),
('U0017', 'password17', 'Mart�n', 'Cruz', 'martin.cruz@example.com', 2, 5),
('U0018', 'password18', 'Luisa', 'Morales', 'luisa.morales@example.com', 3, 1),
('U0019', 'password19', 'Roberto', 'N��ez', 'roberto.nunez@example.com', 4, 2),
...
('U0024', 'password24', 'Renata', 'P�rez', 'renata.perez@example.com', 4, 3),
('U0025', 'password25', 'H�ctor', 'Santana', 'hector.santana@example.com', 5, 4),
('U0026', 'password26', 'Alejandra', 'Cort�s', 'alejandra.cortes@example.com', 1, 1),
('U0027', 'password27', 'Andr�s', 'Vega', 'andres.vega@example.com', 2, 2),
...
('U0030', 'password30', 'Ver�nica', 'Guzm�n', 'veronica.guzman@example.com', 5, 5);
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Crea disparador para evitar la eliminaci�n de usuarios
CREATE TRIGGER Prevent_Delete_Usuario
ON Usuario
INSTEAD OF DELETE
AS
BEGIN
    RAISERROR('No est� permitido eliminar usuarios.', 16, 1);
END;
...
BEGIN
    ...
    -- Verificar duplicados en el caso de una inserci�n
    IF EXISTS (SELECT * FROM inserted)
    BEGIN
        SELECT @id_asesoria = id_asesoria, @boleta_usuario = boleta_usuario FROM inserted;

        -- Verificar si el usuario ya est� registrado en la misma asesor�a
        IF EXISTS (
            SELECT 1
            FROM ListaAlumno
        ...
        BEGIN
            RAISERROR('El usuario ya est� registrado en esta asesor�a.', 16, 1);
...
BEGIN
    ...
    -- Verificar si la asesor�a existe y tiene cupo disponible
    DECLARE @cupo_disponible INT;
    SELECT @cupo_disponible = cupo_disponible FROM InformacionAsesoria WHERE id_asesoria = @id_asesoria;

    IF @cupo_disponible <= 0
    BEGIN
        RAISERROR('La asesor�a no tiene cupo disponible.', 16, 1);
        RETURN;
    END;

    -- Verificar si la combinaci�n de id_asesoria y fecha_inicioAsesoria es v�lida
    IF NOT EXISTS (SELECT 1 FROM ListaAlumno WHERE id_asesoria = @id_asesoria AND fecha_inicioAsesoria = @fecha_inicioAsesoria)
    BEGIN
        RAISERROR('La combinaci�n de id_asesoria y fecha_inicioAsesoria no coincide con los registros existentes.', 16, 1);
        RETURN;
    END;
    ...
    PRINT 'Usuario registrado exitosamente en la asesor�a.';
END;
